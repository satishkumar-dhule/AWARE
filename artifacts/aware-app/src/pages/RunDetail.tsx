    ...
    <AppLayout activeHref="/runs">
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
          <button onClick={() => navigate("/runs")} className="gcp-button gcp-button-xs">
          ...
          <span
            className={`gcp-badge ${run.status === "PASS" ? "gcp-badge-pass" : "gcp-badge-fail"}`}
            style={{ fontSize: 10 }}
          >
            {run.status}
          </span>
          <span
            className={`gcp-badge ${canPromote ? "gcp-badge-pass" : "gcp-badge-fail"}`}
            style={{ fontSize: 10 }}
          >
            {hasDecision
              ? decisionIsPromote
                  ...
                  <tbody>
                    {filtered.map((r) => (
                      ...
                      >
                        ...
                        <td>
                          <span
                            className={`gcp-badge ${r.status === "PASS" ? "gcp-badge-pass" : "gcp-badge-fail"}`}
                          >
                            {r.status}
                          </span>
                        </td>
